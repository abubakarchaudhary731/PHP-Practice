        ...
        <div class="card my-3" style="width: 18rem;">
            ...
            <?php 
                ...
                while ($row = mysqli_fetch_array($result)) {
                    echo '<h5 class="card-title"> <a href="Components/View.php?view=' . $row['category_id'] . '">' . $row['category_name'] . '</a></h5>
                    <p class="card-text">' .substr($row['category_description'], 0, 100) . '...</p>
                    <a href="Components/View.php?view=' . $row['category_id'] . '" class="btn btn-primary"> View </a>';
                }
            ?>
            </div>
        </div>
